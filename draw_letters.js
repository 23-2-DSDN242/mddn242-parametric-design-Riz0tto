...
function interpolate_letter(percent, oldObj, newObj) {
  ...
  new_letter["offsetCx"] = map(percent, 0,  100, oldObj["offsetCx"], newObj["offsetCx"]);
  new_letter["offsetCy"] = map(percent, 0, 100, oldObj["offsetCy"], newObj["offsetCy"]);
  ...
  new_letter["offsetMx"] = map(percent, 0,  100, oldObj["offsetMx"], newObj["offsetMx"]);
  new_letter["offsetMy"] = map(percent, 0, 100, oldObj["offsetMy"], newObj["offsetMy"]);
  ...
  new_letter["offsetYx"] = map(percent, 0,  100, oldObj["offsetYx"], newObj["offsetYx"]);
  new_letter["offsetYy"] = map(percent, 0, 100, oldObj["offsetYy"], newObj["offsetYy"]);
  ...
  new_letter["lineBaseY"]    = map(percent, 0, 100, oldObj["lineBaseY"], newObj["lineBaseY"]);
